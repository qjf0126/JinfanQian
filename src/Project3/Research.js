    ...
    <section id="research3">
      <div className="research3-container">
        ...
        <ul className="research3-list" style={{margin:'20px 0px 40px 0px'}}>
          ...
          <div className="card card-body" style={{padding:'10px',border:'none',background:'none'}}>
            <img src={growth} alt="Growth chart" className="growth"/ >
          </div>
          <li className="research3-list-item">Decline single-use utensils</li>
          <p className="research3-paragraph">
            many food delivery platforms offer “no utensils” options as a way to reduce the waste. Consumers can simply toggle it on. On average, choosing “no utensils” can reduce carbon emissions by 38g per order.
          </p>
          <li className="research3-list-item">Recycle single-use plastics</li>
          <p className="research3-paragraph">
            most of the single-use plastics are incinerated or landfilled rather than recycled. Currently, the recycling rate of plastic waste from Chinese food delivery is only 23.3%, much lower than China's overall plastic recycling rate (31%).
          </p>
          <p className="research3-paragraph">
            The main reason for the low recycling rate is that food delivery waste is often contaminated by food residue and grease, making it difficult to recycle and less desirable for collectors and recycling plants. 
          </p>
        </ul>
