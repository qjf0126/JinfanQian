    ...
    <section id="details3">
      <div className="details3-container">
        ...
        <p className="details3-paragraph">
          I took inspiration from the narrative style of <a href="https://www.unep.org/news-and-stories/story/experience-your-carbon-footprint-vr" target="_blank" rel="noopener noreferrer">"Experience Your Carbon Footprint in VR"</a> for "Tide of Takeout Waste," using a storytelling approach to engage players by immersing them directly in the experience and making the impact of their actions more tangible.
        </p>
        <h2 className="details3-header">Data Visulization</h2>
        <p className="details3-paragraph">
          The visual format of "Tide of Takeout Waste" is inspired by the <a href="https://www.realworldvisuals.com/" target="_blank" rel="noopener noreferrer">"Real World Visuals"</a> project, using comparisons of waste piles or carbon emissions with reference objects to give players a clear sense of the pollution generated by takeout.
        </p>
