...
import Vizualize01 from "./img/visualize01.png";
    ...
    <section id="details3">
      <div className="details3-container">
        ...
        <p className="details3-paragraph" style={{marginBottom: '40px'}}>
          I took inspiration from the narrative style of <a href="https://www.unep.org/news-and-stories/story/experience-your-carbon-footprint-vr" target="_blank" rel="noopener noreferrer">Experience Your Carbon Footprint in VR</a>, using a storytelling approach to engage players by immersing them directly in the experience and making the impact of their actions more tangible.
        </p>
        <h2 className="details3-header">Data Visualization</h2>
        <p className="details3-paragraph">
          I took inspiration from the visualization style of <a href="https://www.realworldvisuals.com/" target="_blank" rel="noopener noreferrer">Real World Visuals</a>, using comparisons of trash piles or carbon emissions with reference objects to give players a clear sense of the pollution generated by food delivery.
        </p>
        <div className='RealWorldDataImg'>
          <div className="RealWorldData">
            <img src={RealWorldData01}></img>
            <p style={{fontSize:'14px', color:'#707070', textAlign:'center', marginTop:'8px'}}>Trash pile in Real World Data</p>
          </div>
          <div className="RealWorldData">
            <img src={Vizualize01}></img>
            <p style={{fontSize:'14px', color:'#707070', textAlign:'center', marginTop:'8px'}}>Trash pile in Tide of Food Delivery Waste</p>
          </div>
        </div>
        <p className="details3-paragraph">
